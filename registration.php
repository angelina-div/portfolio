            ...
            <div class="row flex-grow">
                <div class="col-lg-8 mx-auto">
                  <div class="auth-form-light text-left p-5">
                    ...
                    <form class="pt-3" METHOD="POST" enctype="multipart/form-data" action="database/register.php">
                      <div class="form-group my-2">
                        <input type="text" class="form-control form-control-lg" id="" name="ename" placeholder="Employee Name">
                      </div>
                      <!-- <div class="form-group my-2">
                        <input type="text" class="form-control form-control-lg" id="" name="employeeid" placeholder="Employee Id">
                      </div> -->
                      <div class="form-group my-2">
                        <input type="email" class="form-control form-control-lg" id="" name="email" placeholder="Employee email">
                      </div>
                      <!-- <div class="form-group my-2">
                        <input type="text" class="form-control form-control-lg" id="" name="address" placeholder="Employee Address">
                      </div> -->
                      <div class="form-group my-2">
                        <input type="password" class="form-control form-control-lg" id="" name="pass" placeholder="Password">
                      </div>
                      <div class="form-group my-2">
                        <input type="password" class="form-control form-control-lg" id="exampleInputCPassword" name="cpassword" placeholder="Confirm Password">
                      </div>
                      <div class="mb-4">
                      ...
                      <div class="mt-3">
                        <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="submit" href="">SIGN UP</button>
                      </div>
          ...
          <form action="forms/contact.php" method="post" role="form" class="php-email-form">
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="text" name="ename" class="form-control" id="name" required>
              </div>
              <div class="form-group col-md-6">
